            ...
            <div class="row mt-5">
                <div class="video" >
                    ...
                    @if($video->processed)
                     ...
                     <!-- <video src="/storage/{{$video->stream_path}}" class="w-100" type="application/x-mpegURL" controls></video>-->

                      <video-js id="my_video_1" class="vjs-default-skin" controls preload="auto" width="640" height="268">
    <source src="/storage/{{$video->stream_path}}" type="application/x-mpegURL">
   </video-js>
